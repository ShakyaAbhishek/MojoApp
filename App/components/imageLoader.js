...
//         }}>
//         <View
//           style={{height: height / 2, width: width, backgroundColor: 'red'}}>
...
//           }}>
//           <Svg height={height / 2.5} width={width / 1.8}>
//             <Circle r={height / 2.5} />
  ...
  render() {
    return (
      ...
      >
        ...
        <View style={{ height: 200 / 3, justifyContent: 'center' }}>
          <TapGestureHandler onHandlerStateChange={this.onStateChange}>
            <Animated.View
              style={{
                ...styles.button,
          ...
          <Animated.View style={{height:200/3.9, ...StyleSheet.absoluteFill, top:null, justifyContent:'center', zIndex:this.textInputZndex, opacity:this.textInputOpacity, transform:[{translateY: this.textInputY}] }}>
